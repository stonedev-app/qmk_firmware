...
[_QWERTY] = LAYOUT( \
      ...
      KC_LSFT, KC_MCTL, ADJUST,  KC_LALT, KC_LGUI,   EISU_LOWR, KC_SPC, KC_BSPC, KANA_RAIS, KC_LEFT, KC_DOWN,   KC_UP,   KC_RGHT, KC_RSFT \
      ),
   ...
   */
  [_LOWER] = LAYOUT(
      _______, KC_GRV,  _______, _______, _______, _______,                   _______, _______, _______, _______, _______, KC_BSLS,
