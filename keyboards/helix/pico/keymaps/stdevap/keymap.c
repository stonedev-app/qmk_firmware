...
[_QWERTY] = LAYOUT( \
      ...
      KC_LNG2, KC_MCTL, ADJUST,  KC_LALT, KC_LGUI,  KC_SPC, TAB_LOWR, ENT_RAIS, KC_BSPC,  OPT_KANA, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
...
[_QWERTY_W] = LAYOUT( \
      ...
      KC_LSFT, KC_Z,     KC_X,    KC_C,    KC_V,     KC_B,                           KC_N,     KC_M,     KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
      HANZEN,  WIN_SF_S, ADJUST,  KC_LALT, KC_LCTL,  KC_SPC, TAB_LOWR_W, ENT_RAIS_W, KC_BSPC,  KC_RALT,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
